...
```{r}
# The 3rd row of the stats column provides us with the median expression level of each of the genotypes, which is what we want to extract from the boxplot object!
aa$stats
ag$stats
gg$stats
```
